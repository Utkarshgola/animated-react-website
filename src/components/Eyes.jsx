...
function Eyes() {
    ...
    //using useEffect as we need pionter value after the whole component is displayed
    // taking the center and the mousepointer loaction, finding the diff delta, then findging the anngle with tan.theta
    useEffect(()=>{
